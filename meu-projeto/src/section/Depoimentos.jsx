    ...
    return (
        <section className="depo-section">
            ...
            <div id="ele2" className="depo-element ">
                ...
                <p>"Com o cartão de descontos consegui fazer meus exames de rotina gastando menos da metade. Atendimento rápido e sem fila. Recomendo muito!"</p>
                </div>
            </div>
             <div id="ele3" className="depo-element">
                ...
                <p>"Levei meu filho ao pediatra usando o cartão e foi super em conta. É uma alternativa ótima para quem não tem plano de saúde. Vale a pena!"</p>
                </div>
            </div>
